...
// 두 사람이 함께 카드를 고르는 투표 단계 설정.
export const VOTE_VIEWER_IDS = ['viewer-1', 'viewer-2'];
export const VOTE_REQUIRED_VIEWERS = VOTE_VIEWER_IDS.length;

// 단계별 카드 배율: 아무도 안 봄 → 한 명 응시 → 두 명 응시(최종).
export const VOTE_STAGE_SCALES = [1, 1.07, 1.18];
...
export const VISION_CARDS = [
  ...
  },
  {
    ...
    label: '물소리가 들리는 서울',
    shortLabel: '물소리',
    image: 'https://images.unsplash.com/photo-1432407693411-7769df2050a4?w=400&h=400&fit=crop',
  },
  {
    id: 'food',
    label: '먹을 것이 자라나는 서울',
  ...
  },
  {
    ...
    label: '향기로운 서울',
    shortLabel: '향기',
    image: 'https://images.unsplash.com/photo-1490750967868-88aa4486cfe2?w=400&h=400&fit=crop',
  },
  {
    id: 'rest',
    label: '어디든 편히 앉거나 누울 수 있는 서울',
    shortLabel: '휴식',
