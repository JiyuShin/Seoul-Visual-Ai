...
export default function MobileDrawingPage({
  ...
  return (
      ...
      >
        ...
        <div className={styles.canvasPanelShell} data-figma-node="1693:944">
          <div className={styles.canvasPanel} data-figma-node="1693:945">
          ...
          <div className={styles.paletteWrap} data-figma-node="1672:1115">
            <img className={styles.paletteTray} src="/mobile/palette-tray.svg" alt="" aria-hidden="true" />
